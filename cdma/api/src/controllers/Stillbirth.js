...
async function store(req, res, next) {
    try {
        await check("I_STILL_BIRTH_ID")
            .notEmpty()
            .withMessage("Birth_ID filed must be requerd")
            .run(req);
...
async function update(req, res, next) {
    try {
        ...
        let oldData = await query.queryChaincode(
            ...
            chaincodeName,
            "getDeathCert",
            [req.body.I_STILL_BIRTH_ID, req.body.Key]
        );
        ...
        if (typeof oldData != "object") {
            ...
            if (typeof message != "string") {
                ...
                return res.status(200).json({
                    ...
                    success: true,
                    message:
                        "still birth certificate verified and updated successfully!",
                    data: data,
                });
            }
        }
